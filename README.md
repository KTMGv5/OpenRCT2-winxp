This repository contains a Makefile and source code patch to build OpenRCT2 (v0.4.32 at the time of writing) for Windows XP, as well as precompiled binaries in the [Releases](https://github.com/KTMGv5/OpenRCT2-winxp/releases/) section.

# Instructions

Download the OpenRCT2 Windows x86 Portable zip from [here](https://github.com/OpenRCT2/OpenRCT2/releases/download/v0.4.32/OpenRCT2-v0.4.32-windows-portable-win32.zip) and extract it. Go to the [Releases](https://github.com/KTMGv5/OpenRCT2-winxp/releases/) section, download the zip, and replace openrct2.exe and openrct2-cli.exe with the ones in the zip you just downloaded.
